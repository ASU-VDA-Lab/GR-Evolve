...
make DESIGN_CONFIG=./designs/nangate45/aes/config.mk clean_route
make DESIGN_CONFIG=./designs/nangate45/aes/config.mk finish
install -D /root/OpenROAD-flow-scripts/flow/logs/nangate45/aes/base/5_1_grt.log        /root/TESTS/newgr_autoevolve/GR_newgr_e.${1}_nangate45.log
install -D /root/OpenROAD-flow-scripts/flow/logs/nangate45/aes/base/5_2_route.log      /root/TESTS/newgr_autoevolve/DR_newgr_e.${1}_nangate45.log
