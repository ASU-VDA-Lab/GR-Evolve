...
After reading the summary, you must propose and apply drastic moves that should reduce wirelenght. Main goal is reducing wirelength and in your previous changes have only increased wirelengt. So you may propose radical changes to the global router. You have to **mix and match source code from different global routers** whose source code is provided to you, and you are allowed to come up with your own changes that radically change how the global router operates. First make a theory on why your change would work, then implement that change in the source code. **MAKE WIRELENGTH REDUCTION EVERY ITERATION**. 
...
| ------------------------ | -------------- | --------- | ---------------------- |
| FastRoute 4.1 (Baseline) | 546551         | 385496    | 6388                   |
| CUGR (Baseline)          | 546735         | 411271    | 4414                   |
| SPRoute2 (Baseline)      | 550306         | 397994    | 3169                   |
...
# Main Goal
**You must now strictly focus on **reducing wirelength** below that of baseline FastRoute. You may propose and implement ideas from any avaliable router to create a newer better global router.**
